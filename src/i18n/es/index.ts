...
const es = {
	...
	activateAdminLink: 'Activar Admin',
	...
	reservationCancelProcessing: 'Procesando cancelación...',
	reservationClearCancelledCta: 'Limpiar canceladas',

	// Refactor flujo reserva (v2)
	viewEventCta: 'Ver evento',
	reserveOnlyCta: 'Reservar',
	quantityLabel: 'Cantidad de cupos',
	quantityMaxHint: 'Máximo {n:number} disponibles',
	confirmReserveTitle: '¿Confirmas tu reserva?',
	confirmReserveQtyText: 'Vas a reservar {n:number} cupo(s) para {fecha:string}.',
	confirmCta: 'Sí, continuar',
	cancelCta: 'No, volver',
	generatingReservationLabel: 'Generando tu reserva...',
	...
	reservationFilterAll: 'Todas',
	reservationFilterActive: 'Activas',
	reservationFilterPending: 'Por pagar',
	reservationFilterCancelled: 'Canceladas',
	reservationFilterEmpty: 'No hay reservas en esta categoría.',

	// Card: badges, ocupacion, precio (nueva-logica-panoramas)
	badgePopular: 'Popular',
	badgeTendencia: 'Tendencia',
	openHours: 'Abierto: {open} - {close}',
	nearestDateLabel: 'Fecha más próxima: {fecha:string} · {horarios:string}',
	slotsAvailableSingular: '1 horario disponible',
	slotsAvailableMulti: '{n:number} horarios disponibles',
	moreDatesHint: 'Más fechas y horarios: ver evento',
	occupancyLabel: 'Afluencia: {level}',
	occupancyLabelWithDate: 'Afluencia ({fecha:string}): {level:string}',
	totalSlotsLabel: 'Cupos disponibles: {disp:number}/{total:number}',
	occupancyHigh: 'Alta',
	...
	adminFormPersonLimitLabel: 'Límite por persona',
	adminFormPersonLimitPlaceholder: 'Sin límite',
	adminFormPersonLimitHint: 'Máximo de cupos que una misma persona puede reservar en un mismo horario. Vacío = sin límite.',
	...
	adminManageExpiredLabel: 'Vencido (fechas pasadas)',
	adminManageSoldOutLabel: 'Agotado (sin cupos)',
	...
	adminFormErrorPersonLimitInvalid: 'El límite por persona debe ser mayor a 0.',
	adminFormErrorPersonLimitExceedsSlots: 'El límite por persona no puede ser mayor que los cupos por día.',
	adminFormErrorTimeRangeInvalid: 'En la fecha {fecha}, la hora de inicio debe ser anterior a la de fin.',
	adminFormErrorPastDate: 'La fecha {fecha} ya pasó. Elige una fecha de hoy en adelante.',
